...
short iRobotCreate::getAngle(CreateSensors structure)
{
    return structure.Angle;
}

short iRobotCreate::getDistance(CreateSensors structure)
{
...
void iRobotCreate::doSensorReadings(void *param, ProcessDataFromCreate callback)
{
    while(1)
    {
      ...
      //  printf("%f \n", getAngle(sensor_struct));
      //  printf("%f \n", getDistance(sensor_struct));
    }
}
